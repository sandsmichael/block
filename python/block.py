...
def mining():
    ...
    solution requires brute force (...but watch out when quantum comes :)
    succesfull result entails adding a nonce (bytte value of a number) to the byte contents of the block, hashing it (serialize)
    and having the hash return a value that starts with 5 leading zeros.
    '''
